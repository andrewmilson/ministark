...
// use metal::LibraryRef;

// struct NttPlanner<'a, E> {
...
// impl<'a, E: StarkFelt> NttPlanner<'a, E> {
//     pub fn new() -> Self {
//         let library_data = include_bytes!("../src/metal/ntt.metallib");
//         let start_time = Instant::now();
//         let device = Device::system_default().expect("no device found");
//         let library = device.new_library_with_data(library_data).unwrap();

//         //n: usize, direction: NttDirection) -> Self {
//         // assert!(n.is_power_of_two(), "must be a power of two");
//         // let mut twiddles = Vec::new_in(PageAlignedAllocator);
...
//     fn process(&mut self, buffer: &mut Vec<E, PageAlignedAllocator>) {
//         let input_buffer = buffer_no_copy(buffer);
//         let twiddles_buffer = buffer_no_copy(self.twiddles);
//     }
// }

// impl<E: StarkFelt> Direction for NttPlanner<E> {
