...
- [OpenZKP](https://github.com/0xProject/OpenZKP) - A STARK prover and verifier developed by [Remco Bloemen](https://twitter.com/recmo) and others. OpenZKP inspired the AIR constraints used in miniSTARK. Remco also created a [nice short STARK explanation video](https://www.youtube.com/watch?v=H3AKu03AwYc).